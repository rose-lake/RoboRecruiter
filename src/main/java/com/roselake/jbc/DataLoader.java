...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        if (roleRepository.count() == 0) {
            ...
            // QA RESUME
            resumeRepository.save(new Resume("QATester100",
                    "SDLC, UFT, VBScripts, Agile, Scrum, JIRA, qTest, SQL, test strategies, test plans, fast-paced, presentation, interpersonal, team player"));
            ...
            // DATABASE RESUME
            resumeRepository.save(new Resume("Database100",
                    "database coding, performance tuning, troubleshooting, ETL Technologies, C, C++, Python, Java, PostgreSQL, Oracle SQL, NoSQL, Scylla, Apache Cassandra, Redis, analytical"));
            ...
            // WEB DEV RESUME
            resumeRepository.save(new Resume("WebDev100",
                    "HTML5, CSS3, LESS, SASS, AngularJS, Angular, Git, AWS, Python, D3, Agile/Scrum, cyber security, multitask collaborative typing"));
            ...
            // ANDROID 100 RESUME
            resumeRepository.save(new Resume("Android100",
                    "Java, Kotlin, Android Studio, Objective-C, Swift, XCode, mobile product development, Visual Studio App Center typing collaborative"));
            ...
            // ANDROID 75 RESUME
            resumeRepository.save(new Resume("Android75",
                    "Java, Kotlin, Android Studio, Objective-C, Swift, XCode, typing"));
            ...
            // SOFTWARE ENGINEER 100 RESUME
            resumeRepository.save(new Resume("SoftwareEng100",
                    "Responsive Design, HTML, CSS, JavaScript, JSON, REST, SOAP, Cloud Configuration Management, full systems development lifecycle, API interfaces, analytical, communication, AngularJS"));
